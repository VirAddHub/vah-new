...
// Database adapters
console.log('DB_CLIENT:', process.env.DB_CLIENT || 'sqlite');
const dbModule = require('./db');
console.log('dbModule:', Object.keys(dbModule));
const { ensureSchema, selectOne, selectMany, execute, insertReturningId } = dbModule;
