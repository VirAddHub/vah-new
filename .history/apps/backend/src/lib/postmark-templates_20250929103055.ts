...
export const Templates = {
  ...
  BillingReminder: "billing-reminder", // pragma: allowlist secret
  ...
  KycReminder: "kyc-reminder", // pragma: allowlist secret
  ...
  // Mail events
  MailReceived: "mail-received", // pragma: allowlist secret
