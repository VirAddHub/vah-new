...
// Deprecated entrypoint. Use src/server.ts → dist/src/server.js
// This file is kept for compatibility but should not be used for deployment
if (require.main === module) {
    console.warn('[DEPRECATED] This entrypoint is deprecated. Use: node dist/src/server.js');
    console.warn('[DEPRECATED] Starting anyway for compatibility...');
