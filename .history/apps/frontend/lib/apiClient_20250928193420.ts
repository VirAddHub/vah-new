...
const billing = {
    ...
    manageSubscription: (action: 'pause' | 'resume' | 'cancel') => post<{ ok: true; message?: string }>('/api/billing/subscription/manage', { action }),
};
...
export const apiClient = {
    ...
    submitBusinessInfo: (data: any) => post<{ ok: true; message?: string }>('/api/kyc/business-info', data),
