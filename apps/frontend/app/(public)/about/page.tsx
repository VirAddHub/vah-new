                ...
                <div className="container mx-auto px-4 py-16">
                    <article className="max-w-4xl mx-auto">
                        <header className="text-center mb-12">
                            <h1 className="text-h1 font-bold mb-6">About VirtualAddressHub</h1>
                        ...
                        <div className="prose prose-lg max-w-none">
                            <section className="mb-12">
                                <h2 className="text-h2 font-semibold mb-6">Why We Built This</h2>
                            ...
                            <section className="mb-12">
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div className="bg-card p-6 rounded-lg border border-border">
                                        <h3 className="text-h3 font-semibold mb-4">Central London Address</h3>
                                    ...
                                    <div className="bg-card p-6 rounded-lg border border-border">
                                        <h3 className="text-h3 font-semibold mb-4">Same-Day Digital Processing</h3>
                                        <p className="text-muted-foreground">
                                    ...
                                    <div className="bg-card p-6 rounded-lg border border-border">
                                        <h3 className="text-h3 font-semibold mb-4">Strict Compliance</h3>
                                        <p className="text-muted-foreground">
                                    ...
                                    <div className="bg-card p-6 rounded-lg border border-border">
                                        <h3 className="text-h3 font-semibold mb-4">Privacy First</h3>
                                        <p className="text-muted-foreground">
                            ...
                            <section className="mb-12">
                                <h2 className="text-h2 font-semibold mb-6">Our Commitment to Trust</h2>
                                <p className="text-body-lg leading-relaxed mb-6">
                            ...
                            <section className="mb-12">
                                <h2 className="text-h2 font-semibold mb-6">Get in Touch</h2>
                                <p className="text-body-lg leading-relaxed mb-6">
                                ...
                                <div className="bg-primary/5 p-6 rounded-lg border border-primary/10">
                                    <p className="text-body-lg font-semibold mb-2 text-foreground">Reach Out</p>
                                    <p className="text-muted-foreground mb-4">
                                        We support founders globally setting up in the UK. Contact us for direct guidance on your address requirements.
                                    </p>
                                    <a href="/contact" className="inline-flex font-medium text-primary hover:text-primary/80 underline underline-offset-4">
                                        Contact Support
                                    </a>
                                </div>
                            </section>
