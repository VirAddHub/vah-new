  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="mx-auto max-w-4xl px-6 py-12 space-y-6 text-muted-foreground">
        <h1 className="text-h1 tracking-tight text-primary">Terms of Service</h1>
        ...
        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">1. What We Provide</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">2. Permitted Use</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">3. Legal Compliance</h2>
          <p>You must:</p>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">4. Service Activation</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">5. Mail Handling</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">6. Forwarding</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">9. Privacy</h2>
          <p>See our Privacy Policy for full details on how we handle your information.</p>
        </section>

        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">10. Your Responsibilities</h2>
          <p>You must:</p>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">11. Limitations</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">12. Termination</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">13. Restricted Industries</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-h3 text-foreground">18. AML Supervision</h2>
          <p>
