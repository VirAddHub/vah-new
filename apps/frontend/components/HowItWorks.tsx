        ...
        <section className="w-full py-8">
            <div className="mx-auto max-w-6xl px-6">
                <header className="mx-auto max-w-3xl text-center mb-8">
                    <h2 className="font-bold text-[clamp(1.75rem,4.5vw,3rem)] leading-tight text-gray-900">
                            ...
                            <div className="md:pl-16">
                                <div className="rounded-xl border border-border bg-card shadow-sm">
                                    <div className="p-4 sm:p-6">
                                        <h3 className="font-bold text-[clamp(1.25rem,2.5vw,1.75rem)] text-gray-900">{s.title}</h3>
