        ...
        <>
            ...
            >
                <main className="bg-background text-foreground">
                    {/* HERO */}
                    <section
                        className="relative overflow-hidden section-mobile hero-mobile"
                        aria-label="Hero"
                    >
                        ...
                        <div className="container-mobile grid lg:grid-cols-12 space-mobile-lg items-center">
                            <div className="lg:col-span-7 animate-fade-in-up">
                                ...
                                <div className="mt-10">
                                    <div className="flex flex-col sm:flex-row space-mobile-md">
                                        <Button
                                            onClick={() => handleNavClick?.("signup", { initialBilling: billing })}
                                            className="btn-primary btn-mobile text-mobile-lg px-8 py-4 h-auto mobile-touch-target"
                                        >
                                            {ctaText}
                                        ...
                                        <Button
                                            ...
                                            className="btn-outline btn-mobile text-mobile-lg px-8 py-4 h-auto mobile-touch-target"
                                        >
                                            Learn More
                                        </Button>
                                    </div>
