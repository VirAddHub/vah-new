...
export default function FooterComplianceCTA() {
    ...
    return (
        <section className="mx-auto my-16 max-w-5xl rounded-2xl border border-border bg-card px-6 py-10 text-center shadow-sm">
            <h3 className="text-2xl font-semibold text-foreground">⚖️ Unsure if your current address is compliant?</h3>
            ...
            <ul className="mx-auto mt-2 max-w-2xl space-y-1 text-sm text-muted-foreground text-left">
