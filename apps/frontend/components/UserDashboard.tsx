...
export function UserDashboard({ onLogout, onNavigate, onGoBack }: UserDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-background dashboard-mobile">
      {/* Header */}
      ...
      <div className="container-mobile p-mobile-lg">
        {/* Welcome Section */}
        <div className="mb-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            <Button
              ...
              className="btn-primary btn-mobile mobile-touch-target"
            >
              {certLoading ? (
                <>
            ...
            <div className="space-y-4">
              {mailLoading ? (
                ...
                filteredMailItems.map((item: MailItem) => (
                  <div
                    key={item.id}
                    className={`p-4 border border-border rounded-xl transition-all duration-200 hover:shadow-md ${selectedMail.includes(item.id.toString()) ? 'bg-primary/5 border-primary/50' : 'bg-card'
                      }`}
                  >
                    <div className="flex items-center gap-4">
                      <button
