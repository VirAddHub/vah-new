              ...
              <div role="group" aria-label="Billing period" className="bg-muted flex h-11 w-fit items-center rounded-md p-1 text-sm">
                <div className="grid h-full grid-cols-2 w-full">
                  <button
                    ...
                    className={`h-full rounded-md px-5 font-semibold transition-all ${
                      !isAnnual
                  ...
                  <button
                    ...
                    className={`h-full rounded-md px-5 font-semibold transition-all flex items-center justify-center gap-2 ${
                      isAnnual
                        ? 'bg-primary text-primary-foreground'
                        : 'text-muted-foreground hover:text-foreground'
                    }`}
